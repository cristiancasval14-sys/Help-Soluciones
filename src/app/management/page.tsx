    ...
    return (
        <div className="manage-tickets-page fade-in">
            ...
            <style jsx>{`
                ...
                .modal-content { background: var(--surface); padding: 2.5rem; border-radius: 16px; width: 400px; box-shadow: 0 30px 60px rgba(0,0,0,0.3); border: 1px solid var(--surface-border); }
